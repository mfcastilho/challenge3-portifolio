...
function validando(input) {
  ...
  if (input.validity.valid) {
      ...
      input.parentElement.querySelector('.form__label__erro').innerHTML = showMsgErro(tipoDeInput, input)
  }
}

function showMsgErro(tipoDeInput, input) {
  let mensagem = ''
  erros.forEach(erro => {
